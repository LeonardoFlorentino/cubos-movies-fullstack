...
export function buildPasswordResetTemplate({
  ...
  const text = [
    `Ola ${userName},`,
    '',
    'Recebemos uma solicitacao para redefinir sua senha da Cubos Movies.',
            ...
            <tr>
              <td style="padding:0;background:linear-gradient(120deg,#6d4bc0 0%,#8d67ce 55%,#cbb2f0 100%);">
                <div style="padding:24px 28px;color:#ffffff;">
                  ...
                  <h1 style="margin:0;font-size:24px;line-height:1.25;font-weight:800;">Recuperacao de Senha</h1>
                </div>
              </td>
            </tr>
            <tr>
              <td style="padding:28px;color:#1f2432;">
                <p style="margin:0 0 16px;font-size:16px;line-height:1.55;">Ola <strong>${escapeHtml(userName)}</strong>,</p>
                <p style="margin:0 0 18px;font-size:15px;line-height:1.65;color:#3f4659;">Recebemos uma solicitacao para redefinir sua senha. Clique no botao abaixo para escolher uma nova senha e voltar para seus filmes.</p>
                ...
                <p style="margin:0;font-size:13px;color:#747e94;line-height:1.6;">Se voce nao solicitou isso, pode ignorar este e-mail com seguranca.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:16px 28px;background:#f7f3ff;border-top:1px solid rgba(120,105,164,0.2);font-size:12px;color:#5a6280;">
                <p style="margin:0;">Esta e uma mensagem automatica da Cubos Movies.</p>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid rgba(120,105,164,0.26);border-radius:16px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:28px;color:#1f2432;">
                <p style="margin:0 0 14px;font-size:16px;line-height:1.55;">Ola <strong>${escapeHtml(userName)}</strong>,</p>
